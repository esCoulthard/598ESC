...
def plot_metric_merged(metric_name, metrics_dict, title_prefix="Control", 
    ...
    ax.set_title(f"Pentobarbital 80mg/kg - {metric_name}", fontsize=15)
...
def print_and_plot_combined_metrics_merged(file1, file2, control_individual_files, iso_individual_files, 
    ...
    print("--- Pentobarbital 80mg/kg (Original Weights) ---")
    ...
    for metric in metrics_to_plot:
        ylims = ylim_dict.get(metric)
        plot_metric_merged(metric, iso_metrics, title_prefix="Pentobarbital 80mg/kg", 
