...
# ---------------------------
# This should give you the Average Shortest Path Length, Betweenness Centrality, and Clustering Coefficient for the Low dose conditions.
# ---------------------------
...
# ---------------------------
def plot_metric_low_high(metric_name, metrics_dict, title_prefix="Low dose plot", ylim=None):
...
for metric in metrics_to_plot:
    ...
    plot_metric_low_high(metric, aggregated_metrics, title_prefix="Low Dose", ylim=ylim)
