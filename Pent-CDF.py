...
# ---------------------------
# This computes the cumulative distribution function for the Pentobarital condition, and downloads/displays it for the in/out degrees, along with the left/right hemispheres, giving 4 outputs.
# ---------------------------
...
def plot_combined_cdf(control_csv, iso_csv, hemisphere, trials, bin_size, xlim, ylim, condition,
    ...
    plt.step(x_iso, cdf_iso, where='post', linewidth=2, color="red", label="Pent. 12.5mg/kg")
    
    # Plot high dose condition.
    ...
    plt.step(x_extra, cdf_extra, where='post', linewidth=2, color="magenta", label="Pent. 80mg/kg")
...
iso_csv = r'Source_Sink_analysis\new\pento12.5\edges_numActivation_thresh=1.csv'
iso_files = None
